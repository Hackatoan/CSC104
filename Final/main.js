...
aboutBtn.onclick = () => {
  ...
  mainContent.innerHTML = `
    <section id="about-section" style="padding: 20px; max-width: 800px; margin: auto;">
      ...
      <p>Favicon is generated by Gemini and ran through <a href="https://favicon.io/favicon-converter/" target="_blank" style="color: #1db954; text-decoration: none;">favicon.io</a>.</p>
